...
public class SymbolConfig implements CommandLineRunner {
  ...
  /**
   * For System Design, there should be admin system for stock symbols setup. In case new stock launch in HKEX, our system control the right to support the new symbol.
   * 
   * The admin system should insert, update & delete the stock list. So, this SymbolConfig.class is just for exercise/ testing purpose.
   */
  @Override
